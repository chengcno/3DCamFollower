...
void Cam2R::CreateFolMesh()
{
    ...
    Mesh* cylLink = meshCreator.CreateCylinder(pAnkle_0, folCen - Vector3d (0,0,0.00), rFol, numM);
    Mesh* cylSph = meshCreator.CreateSphere(rFol, folCen - Vector3d (0,0,0.00), numN, numN);
    //Mesh* cylLink2 = meshCreator.CreateCylinder(folCen, folCen - Vector3d (0,0,0.00), rFol, numM);
