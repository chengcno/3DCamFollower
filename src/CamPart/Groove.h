...
public:
    ...
    //vector<Vector3d> foll_position;                 //position of follower joint center
    //vector<Vector3d> foll_Orientation;              //Orientation of follower cylinder
